...
declare module Q {
    interface IPromise<T> {
        then<U>(onFulfill?: (value: T) => any, onReject?: (error: any) => any): IPromise<U>;
    }
    ...
    interface Promise<T> {
         ...
         */
        then<U>(onFulfill?: (value: T) => any, onReject?: (error: any) => any, onProgress?: Function): Promise<U>;
        ...
        fail<U>(onRejected: (reason: any) => any): Promise<U>;
    ...
    export function when<T>(value: any): Promise<T>;

    // If a non-promise value is provided, it will not reject or progress
    export function when<T, U>(value: any, onFulfilled: (val: T) => any, onRejected?: (reason: any) => any, onProgress?: (progress: any) => any): Promise<U>;
    ...
    export function fbind<T>(method: (...args: any[]) => any, ...args: any[]): (...args: any[]) => Promise<T>;
     ...
     * This is especially useful in conjunction with all.
     */
    export function spread<T, U>(promises: IPromise<T>[], onFulfilled: (...args: T[]) => any, onRejected?: (reason: any) => any): Promise<U>;
    ...
    export function Promise<T>(resolver: (resolve: (val: any) => void , reject: (reason: any) => void , notify: (progress: any) => void ) => void ): Promise<T>;
